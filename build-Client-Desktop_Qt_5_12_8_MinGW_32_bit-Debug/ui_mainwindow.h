...
public:
    ...
    void setupUi(QWidget *MainWindow)
    {
        ...
        sizePolicy3.setHeightForWidth(textEdit_show->sizePolicy().hasHeightForWidth());
        textEdit_show->setSizePolicy(sizePolicy3);
        ...
        sizePolicy4.setHeightForWidth(plainTextEdit_input->sizePolicy().hasHeightForWidth());
        plainTextEdit_input->setSizePolicy(sizePolicy4);
        ...
        pushButton_4 = new QPushButton(page_main_1);
        ...
        stackedWidget_middle->setCurrentIndex(0);
