...
public:
    ...
    void setupUi(QWidget *login)
    {
        ...
        sizePolicy2.setHeightForWidth(label_userID->sizePolicy().hasHeightForWidth());
        label_userID->setSizePolicy(sizePolicy2);
        QFont font;
        ...
        pushButton_connect = new QPushButton(login);
        pushButton_connect->setObjectName(QString::fromUtf8("pushButton_connect"));
        pushButton_connect->setStyleSheet(QString::fromUtf8("margin : 20px 0px;\n"
"border : 0px;"));
...
"border : 0px;"));
    ...
    void retranslateUi(QWidget *login)
    {
        ...
        label_status->setText(QApplication::translate("login", "Not connect to server", nullptr));
        ...
        pushButton_connect->setText(QApplication::translate("login", "Connect to server", nullptr));
